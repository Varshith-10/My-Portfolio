...
export const ABOUT_TEXT = `I am a hardworking and creative individual with a passion for problem-solving, fast learning, and innovative development. Along with my technical skills, I excel in teamwork, leadership, communication, and time management. Outside of coding, I enjoy gaming, fitness, music, cinema, photography, and editing, which fuel my creativity. Driven by a strong motivation to become a proficient developer, I aim to craft impactful applications while exploring my fascination with automobiles and emerging technologies.`;
...
export const CONTACT = {
  address: "Vel Tech University, Chennai",
  phoneNo: "+91 7013821578",
  email: "basvarshith@gmail.com",
};
